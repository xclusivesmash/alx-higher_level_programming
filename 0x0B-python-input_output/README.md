...
13. **100-append_after.py** - Write a function that inserts a line of text to a file, after each line containing a specific string.
...
14. **101-stats.py** - Write a script that reads `stdin` line by line and computes metrics:
